...
namespace ITI.GameOfLife.Tests
{
    ...
    public class T1GameOfLifeTests
    {
        ...
        [TestCase( 10, 10 )]
        [TestCase( 7, 20 )]
        public void T06_GiveLife_Kill_and_IsAlive_with_invalid_args_should_throw_ArgumentException( int x, int y )
        {
            Game sut = new Game( 10, 20 );
            Assert.Throws<ArgumentException>( () => sut.GiveLife( x, y ) );
